...
Decay_t = Decay(name = 'Decay_t',
                ...
                partial_widths = {(P.W__plus__,P.b):'((MT**2 - MW**2)*((3*ee**2*MT**2)/(2.*sw**2) + (3*ee**2*MT**4)/(2.*MW**2*sw**2) - (3*ee**2*MW**2)/sw**2))/(96.*cmath.pi*abs(MT)**3)',
                                  (P.WR__plus__,P.b):'((MT**2 - MWR**2)*((3*ee**2*I6a33*kRq**2*MT**2*complexconjugate(I6a33))/(2.*sw**2) + (3*ee**2*I6a33*kRq**2*MT**4*complexconjugate(I6a33))/(2.*MWR**2*sw**2) - (3*ee**2*I6a33*kRq**2*MWR**2*complexconjugate(I6a33))/sw**2))/(96.*cmath.pi*abs(MT)**3)',
                                  (P.WR__plus__,P.d):'((MT**2 - MWR**2)*((3*ee**2*I6a13*kRq**2*MT**2*complexconjugate(I6a13))/(2.*sw**2) + (3*ee**2*I6a13*kRq**2*MT**4*complexconjugate(I6a13))/(2.*MWR**2*sw**2) - (3*ee**2*I6a13*kRq**2*MWR**2*complexconjugate(I6a13))/sw**2))/(96.*cmath.pi*abs(MT)**3)',
                                  (P.WR__plus__,P.s):'((MT**2 - MWR**2)*((3*ee**2*I6a23*kRq**2*MT**2*complexconjugate(I6a23))/(2.*sw**2) + (3*ee**2*I6a23*kRq**2*MT**4*complexconjugate(I6a23))/(2.*MWR**2*sw**2) - (3*ee**2*I6a23*kRq**2*MWR**2*complexconjugate(I6a23))/sw**2))/(96.*cmath.pi*abs(MT)**3)'})
...
Decay_WR__plus__ = Decay(name = 'Decay_WR__plus__',
                         ...
                         partial_widths = {(P.c,P.b__tilde__):'(ee**2*I5a23*kRq**2*MWR**4*complexconjugate(I5a23))/(16.*cmath.pi*sw**2*abs(MWR)**3)',
                                           (P.c,P.d__tilde__):'(ee**2*I5a21*kRq**2*MWR**4*complexconjugate(I5a21))/(16.*cmath.pi*sw**2*abs(MWR)**3)',
                                           (P.c,P.s__tilde__):'(ee**2*I5a22*kRq**2*MWR**4*complexconjugate(I5a22))/(16.*cmath.pi*sw**2*abs(MWR)**3)',
                                           ...
                                           (P.t,P.b__tilde__):'((-MT**2 + MWR**2)*((-3*ee**2*I5a33*kRq**2*MT**2*complexconjugate(I5a33))/(2.*sw**2) - (3*ee**2*I5a33*kRq**2*MT**4*complexconjugate(I5a33))/(2.*MWR**2*sw**2) + (3*ee**2*I5a33*kRq**2*MWR**2*complexconjugate(I5a33))/sw**2))/(48.*cmath.pi*abs(MWR)**3)',
                                           (P.t,P.d__tilde__):'((-MT**2 + MWR**2)*((-3*ee**2*I5a31*kRq**2*MT**2*complexconjugate(I5a31))/(2.*sw**2) - (3*ee**2*I5a31*kRq**2*MT**4*complexconjugate(I5a31))/(2.*MWR**2*sw**2) + (3*ee**2*I5a31*kRq**2*MWR**2*complexconjugate(I5a31))/sw**2))/(48.*cmath.pi*abs(MWR)**3)',
                                           (P.t,P.s__tilde__):'((-MT**2 + MWR**2)*((-3*ee**2*I5a32*kRq**2*MT**2*complexconjugate(I5a32))/(2.*sw**2) - (3*ee**2*I5a32*kRq**2*MT**4*complexconjugate(I5a32))/(2.*MWR**2*sw**2) + (3*ee**2*I5a32*kRq**2*MWR**2*complexconjugate(I5a32))/sw**2))/(48.*cmath.pi*abs(MWR)**3)',
                                           (P.u,P.b__tilde__):'(ee**2*I5a13*kRq**2*MWR**4*complexconjugate(I5a13))/(16.*cmath.pi*sw**2*abs(MWR)**3)',
                                           (P.u,P.d__tilde__):'(ee**2*I5a11*kRq**2*MWR**4*complexconjugate(I5a11))/(16.*cmath.pi*sw**2*abs(MWR)**3)',
                                           (P.u,P.s__tilde__):'(ee**2*I5a12*kRq**2*MWR**4*complexconjugate(I5a12))/(16.*cmath.pi*sw**2*abs(MWR)**3)'})
