...
Decay_t = Decay(name = 'Decay_t',
                ...
                partial_widths = {(P.W__plus__,P.b):'((MT**2 - MW**2)*((3*ee**2*MT**2)/(2.*sw**2) + (3*ee**2*MT**4)/(2.*MW**2*sw**2) - (3*ee**2*MW**2)/sw**2))/(96.*cmath.pi*abs(MT)**3)',
                                  (P.WR__plus__,P.b):'((MT**2 - MWR**2)*((3*ee**2*kRq**2*MT**2)/sw**2 + (3*ee**2*kRq**2*MT**4)/(MWR**2*sw**2) - (6*ee**2*kRq**2*MWR**2)/sw**2))/(96.*cmath.pi*abs(MT)**3)'})
...
Decay_WR__plus__ = Decay(name = 'Decay_WR__plus__',
                         ...
                         partial_widths = {(P.c,P.s__tilde__):'(ee**2*kRq**2*MWR**4)/(8.*cmath.pi*sw**2*abs(MWR)**3)',
                                           ...
                                           (P.t,P.b__tilde__):'((-MT**2 + MWR**2)*((-3*ee**2*kRq**2*MT**2)/sw**2 - (3*ee**2*kRq**2*MT**4)/(MWR**2*sw**2) + (6*ee**2*kRq**2*MWR**2)/sw**2))/(48.*cmath.pi*abs(MWR)**3)',
                                           (P.u,P.d__tilde__):'(ee**2*kRq**2*MWR**4)/(8.*cmath.pi*sw**2*abs(MWR)**3)'})
